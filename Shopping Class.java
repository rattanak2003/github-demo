package com.example.demo.Array.Exercise2;
//import com.example.demo.Array.Customer;
//import com.example.demo.Array.DiscountRate;
//import com.example.demo.Array.Sale;
...
class Customers implements DiscountRates
{
    private String customerName;
    private String customerType;

    public Customers(String customerName, String customerType) {
...
class Sales {
    ...
    public Sales(Customers customer, String date) {
...
public class Main2 {
    public static void main(String[] args) {
        ...
        do {
            ...
            Customers customer = new Customers(customerName, customerType);
            Sales sale = new Sales(customer, saleDate);
